...
const Contact = () => {
  ...
  const SectionAnimation: React.FC<{ children: React.ReactNode; index?: number }> = ({ children, index = 0 }) => {
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label 
                      ...
                      style={{ color: '#302c2c' }} // Secondary color for label
                    >
                ...
                <div className="text-center">
                  <button
                    ...
                    style={{
                      backgroundColor: '#0E0E55', // Primary color for button
                      color: 'white',
                    }}
                  >
                    Send Message
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <svg
                      ...
                      style={{ color: '#0E0E55' }} // Primary color for icon
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
